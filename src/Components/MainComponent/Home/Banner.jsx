...
export default function Banner() {
  return (
    <div className="bg-gradient-bg w-full min-h-screen flex justify-center items-center pt-10 px-2 pb-5">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-10 text-white container">
        ...
        <div className="w-full flex justify-between">
          ...
          <div className="w-full flex justify-center items-center relative">
            ...
            <img
              src={bannerPhone}
              className="max-w-[450px] bannerImageStyle absolute top-[50%]"
